...
namespace EMS
{
    class Program
    {
        ...
        public void Login()
        {
            ...
            int login = aobj.Login(name, password);
            if (login == 1)
            {
        ...
        {
            User obj = null;
            foreach (var el1 in aobj.UserData)
            {
        ...
        public void Checkuser(string name1)
        {
            ...
            {
                User obj = null;
                foreach( var el in aobj.UserData)
                {
        ...
        {
            foreach (var el1 in eobj.EventsData)
            {
        ...
        {
            foreach (var el1 in eobj.BookingData)
            {
        ...
        public void Payment1(string name1)
        {
            ...
            if (obj.UserType.Equals("manager"))
            {
                foreach (var el1 in mobj.BookingData)
                {
                    Console.WriteLine(el1.ToStringb());
                }
                Console.WriteLine("enter booking Id");
            ...
            {
                foreach (var el1 in cnobj.BookingData)
                {
                    Console.WriteLine(el1.ToStringb());
                }
                Console.WriteLine("enter booking Id");
            ...
            {
                foreach (var el1 in cobj.BookingData)
                {
                    Console.WriteLine(el1.ToStringb());
                }
                Console.WriteLine("enter booking Id");
        ...
        public void Checkbookings(string name1)
        {
            ...
            else if (type.Equals("consultant"))
            {
                ...
                Console.WriteLine("enter booking Id");
                name = Convert.ToInt32(Console.ReadLine());
                result = cnobj.CheckBooking(name);
        ...
        public void Register()
        {
            ...
            Console.WriteLine("Enter password:");
            string pass = Console.ReadLine();
            String register = aobj.Register(name, gender, mobile, email, usetype, username, pass);
            Console.WriteLine(register);
            foreach (var el1 in aobj.UserData)
            {
