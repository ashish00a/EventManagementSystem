...
namespace EMS
{
    public class Consultant:Events
    {
        public Consultant() : base() { }
        public Consultant(string ename, string etype, int eprice, int ecprice, int emprice, int ewallet) : base(ename, etype, eprice, ecprice, emprice, ewallet) { }
        public Consultant(int uid, int eid, DateTime bdate, string paystatus) : base(uid, eid, bdate, paystatus) { }
